                            ...
                            <table className="viewAnnouncement-Table">
                                <tr className="fnt-poppins background-white has-height-100">
                                    <div className="is-flex main-div-of-file">
                                        ...
                                        <img className="edit-image-table  has-margin-top-5 has-margin-left-20 has-width-20 has-height-20" src={Editlogo} />
                                    </div>
                                    <div className="is-flex main-div-of-file">
                                        <li className="has-padding-top-10 has-padding-left-10 list-style">Sitemap<span></span></li>
                                        <img className="edit-image-table  has-margin-top-5 has-margin-left-10 has-width-20 has-height-20" src={Editlogo} />
                                    </div>
                                </tr>
                            </table>
