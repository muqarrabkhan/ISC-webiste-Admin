    ...
    return (
        ...
        <div className="container-fluid Table-for-administrator-main-div">
            ...
            <div className="header-of-viewAdministrator">
                ...
                <Link to={"/administrator"}><button className="header-btn-of-table fnt-poppins">Back</button></Link>
            </div>
                    ...
                    <div className="background-of-table">
                        ...
                        <div className="Form-section-startup">
                            ...
                            <div className="has-margin-left-60 fnt-poppins has-margin-top-20">
                                ...
                                <div className="has-margin-top-10">
                                <input className="checkbox-for-edit-forms has-margin-left-5" type="checkbox" />
                                </div>
                            </div>
                            {/* Select Password*/}
                            <div className="has-margin-left-60 fnt-poppins has-margin-top-20">
